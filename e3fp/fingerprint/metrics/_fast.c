 ...
 */
      ...
      /* "e3fp/fingerprint/metrics/_fast.pyx":47
 *                     sum_max += Y[iy, j]
 * 
 *             if sum_max == 0:             # <<<<<<<<<<<<<<
 *                 S[ix, iy] = 0
...
/* "e3fp/fingerprint/metrics/_fast.pyx":53
 * 
 * 
...
static void __pyx_f_4e3fp_11fingerprint_7metrics_5_fast__sparse_soergel(__Pyx_memviewslice __pyx_v_Xdata, __Pyx_memviewslice __pyx_v_Xindices, __Pyx_memviewslice __pyx_v_Xindptr, __Pyx_memviewslice __pyx_v_Ydata, __Pyx_memviewslice __pyx_v_Yindices, __Pyx_memviewslice __pyx_v_Yindptr, __Pyx_memviewslice __pyx_v_S) {
  ...
  /* "e3fp/fingerprint/metrics/_fast.pyx":63
 ...
 */
              ...
              /* "e3fp/fingerprint/metrics/_fast.pyx":93
 *                         jy += 1
 *                     else:
 *                         diff = Xdata[jx] - Ydata[jy]             # <<<<<<<<<<<<<<
 *                         if diff > 0:
 ...
 */
                ...
                /* "e3fp/fingerprint/metrics/_fast.pyx":98
 *                             sum_max += Xdata[jx]
 *                         else:
 *                             sum_abs_diff -= diff             # <<<<<<<<<<<<<<
 *                             sum_max += Ydata[jy]
 ...
 */
            ...
            /* "e3fp/fingerprint/metrics/_fast.pyx":103
 *                         jy += 1
 * 
 *                 while jx <= jxindmax:             # <<<<<<<<<<<<<<
 *                     sum_max += Xdata[jx]
 ...
 */
            ...
            /* "e3fp/fingerprint/metrics/_fast.pyx":108
 *                     jx += 1
 * 
 *                 while jy <= jyindmax:             # <<<<<<<<<<<<<<
 *                     sum_max += Ydata[jy]
 ...
 */
            ...
            /* "e3fp/fingerprint/metrics/_fast.pyx":113
 *                     jy += 1
 * 
 *                 if sum_max == 0:             # <<<<<<<<<<<<<<
 *                     S[ix, iy] = 0
